              ...
              <my-grid>
                <my-card grow>
                  ...
                  <my-flex slot="content">
                    <my-grid style="grid-template-columns: 1fr 1fr;">
                      ...
                      <input
                        @input="${(e: any) => this.primaryColorChanged(e)}"
                      ...
                      <input
                        @input="${(e: any) => this.secondaryColorChanged(e)}"
                ...
                <my-card grow>
                  ...
                  <my-flex slot="content">
                    <mwc-button
                      outlined
                      @click="${() => this.setDefaultTheme()}"
                      >Defaut</mwc-button
                    >
                    <mwc-button
                      outlined
                      @click="${() => this.setTheme("light")}"
                      >Light theme</mwc-button
                    >
                    <mwc-button outlined @click="${() => this.setTheme("dark")}"
                      >Dark theme</mwc-button
                    >
                    <mwc-button
                      outlined
